<template>
  ...
  <div class="absolute bottom-0 left-0 w-full bg-slate-900/70 backdrop-blur-sm py-4 px-6 overflow-x-auto flex gap-4">
    <div 
      ...
      :class="['min-w-[180px] p-4 rounded-xl cursor-pointer shrink-0 transition-all text-center', selectedUnit?.id === unit.id ? 'bg-cyan-500/80 scale-105' : 'bg-slate-800/60 hover:bg-slate-700']"
    >
