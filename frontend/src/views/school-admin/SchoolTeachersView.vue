        ...
        <table class="w-full">
          ...
          <tbody>
            ...
            >
              <td class="px-6 py-4">
                <span
                  class="text-xs bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded"
                >
...
async function fetchTeachers() {
  ...
  try {
    ...
    const schoolAdmin = JSON.parse(localStorage.getItem("schoolAdmin") || "{}");
